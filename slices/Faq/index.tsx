...
<<<<<<< HEAD
  const [pathVisibility, setPathVisibility] = useState(
    Array(slice?.primary?.faqs?.length).fill(true)
  );
=======
  const [pathVisibility, setPathVisibility] = useState(Array(slice.primary.faqs.length).fill(true));
>>>>>>> 38647a988eccfd6c887cebf32713f0cf3770b6d8

  const togglePathVisibility = (index) => {
    const newPathVisibility = [...pathVisibility];
    newPathVisibility[index] = !newPathVisibility[index];
    setPathVisibility(newPathVisibility);
  };
  return (
      ...
      <div className="mx-auto px-5 w-full max-w-screen-lg">
        <div className="flex flex-col items-center">
          <h3 className="mt-5 heading text-center text-3xl md:text-5xl  md:leading-[58px]">
            ...
            <span className="text-default-blue">{slice?.primary?.title2}</span>
          </h3>
                ...
                <div className="py-5 w-full p-2 px-8">
                  <details className="group">
                    <summary
                      ...
                      onClick={() => togglePathVisibility(index)}
                    >
                  ...
                  >
                    ...
                    <span className="transition font-semibold">
                      <svg
                        ...
                        width="24"
                      >
                        {pathVisibility[index] ? <path d="M12 5v14"></path> : null}
                        <path d="M5 12h14"></path>
                      </svg>
                    </span>
                  </summary>
